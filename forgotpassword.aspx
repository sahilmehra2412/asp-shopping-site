...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="z-index: 102; left: 254px; position: relative; top: -40px">
        ...
        <tr>
            ...
            <asp:Button ID="btnsubmit1" runat="server" Style="z-index: 100; left: 1px; 
        top: 0px; position: relative; font-size: 10pt; color: #ff6600;" Text="Submit" 
                    OnClick="btnsubmit1_Click" TabIndex="5" />
            </td>
            <td style="width: 100px; height: 26px;">
            </td>
        </tr>
