...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="z-index: 100; left: 304px; width: 500px; position: absolute; top: 280px;
        ...
        <tr>
            ...
            <asp:Button ID="btnsubmit" runat="server" Text="Submit" style="left: -54px; position: relative; top: 16px; color: #ff6600;" ForeColor="OrangeRed" OnClick="btnsubmit_Click" /></td>
            <td style="width: 100px; height: 29px;">
            </td>
        </tr>
    </table>
    <asp:Label ID="lblmsg1" runat="server" Style="z-index: 101; left: 0px; position: relative;
        top: -76px; width: 111px;" Height="64px"></asp:Label><br />
    <br />
